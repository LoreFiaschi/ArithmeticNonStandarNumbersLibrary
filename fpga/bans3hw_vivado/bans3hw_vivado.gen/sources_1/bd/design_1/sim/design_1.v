...
module design_1
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.BUS_IN DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.BUS_IN, LAYERED_METADATA undef" *) input [127:0]bus_in;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.BUS_OUT DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.BUS_OUT, LAYERED_METADATA undef" *) output [159:0]bus_out;
  ...
  assign b_op1_0_1 = bus_in[127:0];
  assign bus_out[159:0] = ban_interface_0_ap_return;
