...
entity main_mul_body_Pipeline_VITIS_LOOP_84_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of main_mul_body_Pipeline_VITIS_LOOP_84_1 is 
...
attribute shreg_extract : string;
    ...
    signal idx_53_fu_114_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal idx_53_reg_264 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal idx_47_fu_48 : STD_LOGIC_VECTOR (1 downto 0);
    signal idx_52_fu_160_p3 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal idx_tmp_fu_52 : STD_LOGIC_VECTOR (31 downto 0);
    signal idx_54_fu_205_p3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_110_fu_134_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    mux_32_32_1_1_U180 : component main_mux_32_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din1 => agg_result_num12_0,
        din2 => agg_result_num2_0,
        din3 => idx_47_fu_48,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ...
                    idx_tmp_fu_52 <= idx_54_fu_205_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln84_fu_99_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                idx_53_reg_264 <= idx_53_fu_114_p2;
    ...
    and_ln85_fu_177_p2 <= (or_ln85_fu_173_p2 and grp_fu_1274_p_dout0);
    ...
    ap_sig_allocacmp_idx_tmp_load_8_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0, idx_tmp_fu_52, idx_54_fu_205_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            ap_sig_allocacmp_idx_tmp_load_8 <= idx_54_fu_205_p3;
        else 
    ...
    grp_fu_1274_p_din0 <= tmp_s_fu_120_p5;
    grp_fu_1274_p_din1 <= ap_const_lv32_0;
    grp_fu_1274_p_opcode <= ap_const_lv5_1;
    icmp_ln84_fu_99_p2 <= "1" when (idx_47_fu_48 = ap_const_lv2_3) else "0";
    icmp_ln85_11_fu_148_p2 <= "0" when (tmp_110_fu_134_p4 = ap_const_lv8_FF) else "1";
    icmp_ln85_12_fu_154_p2 <= "1" when (trunc_ln85_fu_144_p1 = ap_const_lv23_0) else "0";
    icmp_ln85_fu_108_p2 <= "1" when (ap_sig_allocacmp_idx_tmp_load_8 = ap_const_lv32_0) else "0";
    idx_52_fu_160_p3 <= 
        idx_53_fu_114_p2 when (icmp_ln85_fu_108_p2(0) = '1') else 
        idx_47_fu_48;
    idx_53_fu_114_p2 <= std_logic_vector(unsigned(idx_47_fu_48) + unsigned(ap_const_lv2_1));
    idx_54_fu_205_p3 <= 
        zext_ln81_fu_201_p1 when (icmp_ln85_reg_258(0) = '1') else 
        idx_tmp_load_8_reg_253;
    idx_fu_194_p3 <= 
        idx_53_reg_264 when (and_ln85_6_fu_189_p2(0) = '1') else 
        ap_const_lv2_0;
    ...
    tmp_110_fu_134_p4 <= bitcast_ln85_fu_130_p1(30 downto 23);
