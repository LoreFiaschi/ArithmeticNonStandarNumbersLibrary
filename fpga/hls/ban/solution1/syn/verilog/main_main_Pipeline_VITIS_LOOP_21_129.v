...
wire    ap_loop_init;
reg   [1:0] ap_sig_allocacmp_i_51;
wire   [1:0] i_51_load_fu_82_p1;
reg   [31:0] b5_num_load_fu_44;
wire   [31:0] tmp_125_fu_97_p5;
...
always @ (posedge ap_clk) begin
    if (((i_51_load_fu_82_p1 == 2'd1) & (icmp_ln21_fu_85_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        b5_num_load_1_fu_48 <= tmp_125_fu_97_p5;
    end
end

always @ (posedge ap_clk) begin
    if ((~(i_51_load_fu_82_p1 == 2'd1) & ~(i_51_load_fu_82_p1 == 2'd0) & (icmp_ln21_fu_85_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        b5_num_load_2_fu_52 <= tmp_125_fu_97_p5;
    end
end

always @ (posedge ap_clk) begin
    if (((i_51_load_fu_82_p1 == 2'd0) & (icmp_ln21_fu_85_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
assign add_ln21_fu_91_p2 = (ap_sig_allocacmp_i_51 + 2'd1);
...
assign i_51_load_fu_82_p1 = ap_sig_allocacmp_i_51;

assign icmp_ln21_fu_85_p2 = ((ap_sig_allocacmp_i_51 == 2'd3) ? 1'b1 : 1'b0);
