...
module main_operator_Pipeline_VITIS_LOOP_84_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign and_ln85_fu_177_p2 = (or_ln85_fu_173_p2 & grp_fu_2010_p_dout0);
...
assign grp_fu_2010_p_din0 = tmp_s_fu_120_p5;

assign grp_fu_2010_p_din1 = 32'd0;

assign grp_fu_2010_p_opcode = 5'd1;

assign icmp_ln84_fu_99_p2 = ((idx_1_fu_48 == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln85_1_fu_148_p2 = ((tmp_21_fu_134_p4 != 8'd255) ? 1'b1 : 1'b0);
...
assign tmp_21_fu_134_p4 = {{bitcast_ln85_fu_130_p1[30:23]}};
...
endmodule //main_operator_Pipeline_VITIS_LOOP_84_1
