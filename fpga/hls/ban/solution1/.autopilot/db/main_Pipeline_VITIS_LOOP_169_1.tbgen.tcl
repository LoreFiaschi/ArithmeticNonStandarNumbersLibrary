set moduleName main_Pipeline_VITIS_LOOP_169_1
set isTopModule 0
...
set C_modelName {main_Pipeline_VITIS_LOOP_169_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ sub_ln542 int 6 regular  }
	{ b_num float 32 regular {array 36 { 1 1 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
	{ b_num_load_77 float 32 regular  }
	{ b_num_load_37 float 32 regular  }
	{ b_num_load_38 float 32 regular  }
	{ aux_4 float 32 regular {array 5 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sub_ln542", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "b_num_load_77", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "b_num_load_37", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "b_num_load_38", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "aux_4", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ b_num_address2 sc_out sc_lv 6 signal 1 } 
	{ b_num_ce2 sc_out sc_logic 1 signal 1 } 
	{ b_num_q2 sc_in sc_lv 32 signal 1 } 
	{ b_num_load_77 sc_in sc_lv 32 signal 2 } 
	{ b_num_load_37 sc_in sc_lv 32 signal 3 } 
	{ b_num_load_38 sc_in sc_lv 32 signal 4 } 
	{ aux_4_address0 sc_out sc_lv 3 signal 5 } 
	{ aux_4_ce0 sc_out sc_logic 1 signal 5 } 
	{ aux_4_we0 sc_out sc_logic 1 signal 5 } 
	{ aux_4_d0 sc_out sc_lv 32 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "b_num_address2", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "b_num", "role": "address2" }} , 
 	{ "name": "b_num_ce2", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "b_num", "role": "ce2" }} , 
 	{ "name": "b_num_q2", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "b_num", "role": "q2" }} , 
 	{ "name": "b_num_load_77", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "b_num_load_77", "role": "default" }} , 
 	{ "name": "b_num_load_37", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "b_num_load_37", "role": "default" }} , 
 	{ "name": "b_num_load_38", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "b_num_load_38", "role": "default" }} , 
 	...
 	{ "name": "aux_4_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "aux_4", "role": "we0" }} , 
 	{ "name": "aux_4_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "aux_4", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	b_num { ap_memory {  { b_num_address0 mem_address 1 6 }  { b_num_ce0 mem_ce 1 1 }  { b_num_q0 mem_dout 0 32 }  { b_num_address1 MemPortADDR2 1 6 }  { b_num_ce1 MemPortCE2 1 1 }  { b_num_q1 MemPortDOUT2 0 32 }  { b_num_address2 MemPortADDR2 1 6 }  { b_num_ce2 MemPortCE2 1 1 }  { b_num_q2 MemPortDOUT2 0 32 } } }
	b_num_load_77 { ap_none {  { b_num_load_77 in_data 0 32 } } }
	b_num_load_37 { ap_none {  { b_num_load_37 in_data 0 32 } } }
	b_num_load_38 { ap_none {  { b_num_load_38 in_data 0 32 } } }
	aux_4 { ap_memory {  { aux_4_address0 mem_address 1 3 }  { aux_4_ce0 mem_ce 1 1 }  { aux_4_we0 mem_we 1 1 }  { aux_4_d0 mem_din 1 32 } } }
}
