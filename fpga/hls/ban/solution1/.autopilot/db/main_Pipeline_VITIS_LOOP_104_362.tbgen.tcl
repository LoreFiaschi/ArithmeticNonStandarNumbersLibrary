set moduleName main_Pipeline_VITIS_LOOP_104_362
set isTopModule 0
...
set C_modelName {main_Pipeline_VITIS_LOOP_104_362}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln104_19 int 2 regular  }
	{ select_ln104_11 int 3 regular  }
	{ sub_ln542 int 6 regular  }
	{ b_num float 32 regular {array 36 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln104_19", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "select_ln104_11", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln104_19 sc_in sc_lv 2 signal 0 } 
	{ select_ln104_11 sc_in sc_lv 3 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln104_19", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "zext_ln104_19", "role": "default" }} , 
 	{ "name": "select_ln104_11", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "select_ln104_11", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln104_19 { ap_none {  { zext_ln104_19 in_data 0 2 } } }
	select_ln104_11 { ap_none {  { select_ln104_11 in_data 0 3 } } }
