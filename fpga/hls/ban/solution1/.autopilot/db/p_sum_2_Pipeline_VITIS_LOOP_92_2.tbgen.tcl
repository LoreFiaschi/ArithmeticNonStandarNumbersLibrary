set moduleName p_sum_2_Pipeline_VITIS_LOOP_92_2
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "agg_result_num_0", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "tmp_321", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "agg_result_num16_0_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ tmp_321 sc_in sc_lv 32 signal 2 } 
	...
	{ agg_result_num16_0_out sc_out sc_lv 32 signal 6 } 
	{ agg_result_num16_0_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ agg_result_num2_0_out sc_out sc_lv 32 signal 7 } 
	{ agg_result_num2_0_out_ap_vld sc_out sc_logic 1 outvld 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_321", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "tmp_321", "role": "default" }} , 
 	...
 	{ "name": "agg_result_num16_0_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "agg_result_num16_0_out", "role": "default" }} , 
 	{ "name": "agg_result_num16_0_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "agg_result_num16_0_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_32_32_1_1_U1003", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	tmp_321 { ap_none {  { tmp_321 in_data 0 32 } } }
	...
	agg_result_num16_0_out { ap_vld {  { agg_result_num16_0_out out_data 1 32 }  { agg_result_num16_0_out_ap_vld out_vld 1 1 } } }
