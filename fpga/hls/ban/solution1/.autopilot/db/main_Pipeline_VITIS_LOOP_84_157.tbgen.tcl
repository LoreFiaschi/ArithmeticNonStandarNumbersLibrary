set moduleName main_Pipeline_VITIS_LOOP_84_157
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "sub_ln542", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "idx_tmp_48_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ idx_tmp_48_out sc_out sc_lv 32 signal 2 } 
	{ idx_tmp_48_out_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "idx_tmp_48_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "idx_tmp_48_out", "role": "default" }} , 
 	{ "name": "idx_tmp_48_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "idx_tmp_48_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	idx_tmp_48_out { ap_vld {  { idx_tmp_48_out out_data 1 32 }  { idx_tmp_48_out_ap_vld out_vld 1 1 } } }
}
