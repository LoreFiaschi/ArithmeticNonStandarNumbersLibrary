set moduleName p_sum_2_Pipeline_VITIS_LOOP_104_3
set isTopModule 0
...
set C_modelName {_sum.2_Pipeline_VITIS_LOOP_104_3}
...
set C_modelArgMapList {[ 
	{ "Name" : "agg_result_num_3", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln104_21", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln104_21 sc_in sc_lv 3 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln104_21", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "zext_ln104_21", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln104_21 { ap_none {  { zext_ln104_21 in_data 0 3 } } }
