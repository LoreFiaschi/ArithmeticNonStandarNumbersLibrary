set moduleName main_Pipeline_VITIS_LOOP_84_174
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "b8_num_0_2_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "idx_tmp_25_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ b8_num_0_2_reload sc_in sc_lv 32 signal 0 } 
	{ b8_num_1_2_reload sc_in sc_lv 32 signal 1 } 
	{ b8_num_2_2_reload sc_in sc_lv 32 signal 2 } 
	{ idx_tmp_25_out sc_out sc_lv 32 signal 3 } 
	{ idx_tmp_25_out_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "idx_tmp_25_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "idx_tmp_25_out", "role": "default" }} , 
 	{ "name": "idx_tmp_25_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "idx_tmp_25_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_32_32_1_1_U947", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	idx_tmp_25_out { ap_vld {  { idx_tmp_25_out out_data 1 32 }  { idx_tmp_25_out_ap_vld out_vld 1 1 } } }
}
