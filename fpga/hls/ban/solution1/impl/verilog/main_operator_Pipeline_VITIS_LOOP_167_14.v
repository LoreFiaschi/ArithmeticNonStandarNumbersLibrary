...
module main_operator_Pipeline_VITIS_LOOP_167_14 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign grp_fu_778_p_din0 = mul_i_i1_reg_321;
...
assign grp_fu_782_p_din1 = mul_1_i_i1_reg_342;
...
assign grp_fu_786_p_din1 = mul_2_i_i1_reg_363;
...
assign tmp_16_fu_197_p4 = ($signed(trunc_ln171_reg_310_pp0_iter3_reg) + $signed(2'd3));

assign tmp_17_fu_229_p4 = (trunc_ln171_reg_310_pp0_iter7_reg ^ 2'd2);

assign tmp_20_fu_206_p3 = ((icmp_ln170_reg_305_pp0_iter6_reg[0:0] == 1'b1) ? grp_fu_778_p_dout0 : 32'd0);

assign tmp_22_fu_238_p3 = ((icmp_ln170_1_reg_326_pp0_iter10_reg[0:0] == 1'b1) ? grp_fu_782_p_dout0 : tmp_20_reg_336_pp0_iter10_reg);

assign tmp_24_fu_244_p3 = ((icmp_ln170_2_reg_347_pp0_iter14_reg[0:0] == 1'b1) ? grp_fu_786_p_dout0 : tmp_22_reg_357_pp0_iter14_reg);
...
endmodule //main_operator_Pipeline_VITIS_LOOP_167_14
