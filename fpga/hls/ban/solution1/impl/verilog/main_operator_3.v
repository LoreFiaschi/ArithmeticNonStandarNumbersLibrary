...
wire   [0:0] icmp_ln60_fu_289_p2;
reg   [0:0] icmp_ln60_reg_555;
wire   [0:0] and_ln60_fu_330_p2;
reg   [0:0] and_ln60_reg_559;
wire    ap_CS_fsm_state2;
wire   [0:0] icmp_ln60_9_fu_336_p2;
reg   [0:0] icmp_ln60_9_reg_563;
wire   [0:0] icmp_ln60_10_fu_359_p2;
reg   [0:0] icmp_ln60_10_reg_567;
wire   [0:0] icmp_ln60_11_fu_365_p2;
reg   [0:0] icmp_ln60_11_reg_572;
wire   [0:0] and_ln60_2_fu_375_p2;
reg   [0:0] and_ln60_2_reg_577;
wire    ap_CS_fsm_state4;
wire   [1:0] trunc_ln136_fu_385_p1;
reg   [1:0] trunc_ln136_reg_581;
wire   [0:0] icmp_ln139_fu_389_p2;
reg   [0:0] icmp_ln139_reg_588;
wire   [0:0] icmp_ln142_fu_395_p2;
reg   [0:0] icmp_ln142_reg_592;
wire   [0:0] tmp_94_fu_401_p3;
reg   [0:0] tmp_94_reg_596;
wire    ap_CS_fsm_state6;
wire   [1:0] sub_ln115_fu_425_p2;
reg   [1:0] sub_ln115_reg_620;
reg   [31:0] b_num_load_7_reg_625;
reg   [0:0] tmp_95_reg_630;
reg   [31:0] b_num_load_9_reg_634;
wire    ap_CS_fsm_state8;
wire   [31:0] select_ln115_fu_441_p3;
wire    ap_CS_fsm_state11;
wire   [31:0] tmp_86_fu_453_p5;
...
wire   [63:0] zext_ln131_1_fu_262_p1;
wire   [63:0] zext_ln131_2_fu_273_p1;
wire   [63:0] zext_ln131_3_fu_284_p1;
...
wire   [10:0] trunc_ln131_fu_244_p1;
wire   [12:0] tmp_119_cast_fu_248_p3;
wire   [12:0] zext_ln131_fu_240_p1;
wire   [12:0] sub_ln131_fu_256_p2;
wire   [12:0] add_ln131_fu_267_p2;
wire   [12:0] add_ln131_1_fu_278_p2;
wire   [31:0] bitcast_ln60_fu_295_p1;
wire   [7:0] tmp_fu_298_p4;
wire   [22:0] trunc_ln60_fu_308_p1;
wire   [0:0] icmp_ln60_8_fu_318_p2;
wire   [0:0] icmp_ln60_7_fu_312_p2;
wire   [0:0] or_ln60_fu_324_p2;
wire   [31:0] bitcast_ln60_1_fu_341_p1;
wire   [7:0] tmp_83_fu_345_p4;
wire   [22:0] trunc_ln60_1_fu_355_p1;
wire   [0:0] or_ln60_1_fu_371_p2;
wire   [31:0] diff_p_fu_381_p2;
wire   [0:0] trunc_ln115_fu_438_p1;
wire   [1:0] tmp_86_fu_453_p4;
reg    grp_fu_221_ce;
reg    grp_fu_226_ce;
...
always @ (posedge ap_clk) begin
    if ((((1'd1 == and_ln60_2_fu_375_p2) & (1'b1 == ap_CS_fsm_state4) & (icmp_ln60_9_reg_563 == 1'd1)) | ((1'b1 == ap_CS_fsm_state4) & (((icmp_ln139_fu_389_p2 == 1'd1) & (icmp_ln60_9_reg_563 == 1'd0)) | ((icmp_ln139_fu_389_p2 == 1'd1) & (1'd0 == and_ln60_2_fu_375_p2)))))) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state20) | (1'b1 == ap_CS_fsm_state17) | ((1'b1 == ap_CS_fsm_state14) & (((((tmp_94_reg_596 == 1'd1) & (icmp_ln142_reg_592 == 1'd0) & (icmp_ln139_reg_588 == 1'd0) & (1'd0 == and_ln60_reg_559) & (1'd0 == and_ln60_2_reg_577)) | ((tmp_94_reg_596 == 1'd1) & (icmp_ln142_reg_592 == 1'd0) & (icmp_ln139_reg_588 == 1'd0) & (1'd0 == and_ln60_reg_559) & (icmp_ln60_9_reg_563 == 1'd0))) | ((icmp_ln60_reg_555 == 1'd0) & (tmp_94_reg_596 == 1'd1) & (icmp_ln142_reg_592 == 1'd0) & (icmp_ln139_reg_588 == 1'd0) & (1'd0 == and_ln60_2_reg_577))) | ((icmp_ln60_reg_555 == 1'd0) & (tmp_94_reg_596 == 1'd1) & (icmp_ln142_reg_592 == 1'd0) & (icmp_ln139_reg_588 == 1'd0) & (icmp_ln60_9_reg_563 == 1'd0)))))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state14) & (((((tmp_94_reg_596 == 1'd1) & (icmp_ln142_reg_592 == 1'd0) & (icmp_ln139_reg_588 == 1'd0) & (1'd0 == and_ln60_reg_559) & (1'd0 == and_ln60_2_reg_577)) | ((tmp_94_reg_596 == 1'd1) & (icmp_ln142_reg_592 == 1'd0) & (icmp_ln139_reg_588 == 1'd0) & (1'd0 == and_ln60_reg_559) & (icmp_ln60_9_reg_563 == 1'd0))) | ((icmp_ln60_reg_555 == 1'd0) & (tmp_94_reg_596 == 1'd1) & (icmp_ln142_reg_592 == 1'd0) & (icmp_ln139_reg_588 == 1'd0) & (1'd0 == and_ln60_2_reg_577))) | ((icmp_ln60_reg_555 == 1'd0) & (tmp_94_reg_596 == 1'd1) & (icmp_ln142_reg_592 == 1'd0) & (icmp_ln139_reg_588 == 1'd0) & (icmp_ln60_9_reg_563 == 1'd0))))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state8) & (tmp_95_reg_630 == 1'd1))) begin
        agg_result_num16_0_i_reg_130 <= reg_233;
    end else if (((1'b1 == ap_CS_fsm_state11) & (tmp_95_reg_630 == 1'd0))) begin
        agg_result_num16_0_i_reg_130 <= grp_fu_12738_p_dout0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln60_9_reg_563 == 1'd1))) begin
        and_ln60_2_reg_577 <= and_ln60_2_fu_375_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln60_reg_555 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        b_num_addr_1_reg_543 <= zext_ln131_2_fu_273_p1;
        b_num_addr_2_reg_549 <= zext_ln131_3_fu_284_p1;
        b_num_addr_reg_537 <= zext_ln131_1_fu_262_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        ...
        tmp_95_reg_630 <= sub_ln115_fu_425_p2[32'd1];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & ((1'd0 == and_ln60_2_fu_375_p2) | (icmp_ln60_9_reg_563 == 1'd0)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (((icmp_ln139_fu_389_p2 == 1'd0) & (icmp_ln60_9_reg_563 == 1'd0)) | ((icmp_ln139_fu_389_p2 == 1'd0) & (1'd0 == and_ln60_2_fu_375_p2))))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & ((icmp_ln60_reg_555 == 1'd0) | (1'd0 == and_ln60_fu_330_p2)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (((icmp_ln142_fu_395_p2 == 1'd0) & (icmp_ln139_fu_389_p2 == 1'd0) & (icmp_ln60_9_reg_563 == 1'd0)) | ((icmp_ln142_fu_395_p2 == 1'd0) & (icmp_ln139_fu_389_p2 == 1'd0) & (1'd0 == and_ln60_2_fu_375_p2))))) begin
        tmp_94_reg_596 <= diff_p_fu_381_p2[32'd31];
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state14) & (((((tmp_94_reg_596 == 1'd1) & (icmp_ln142_reg_592 == 1'd0) & (icmp_ln139_reg_588 == 1'd0) & (1'd0 == and_ln60_reg_559) & (1'd0 == and_ln60_2_reg_577)) | ((tmp_94_reg_596 == 1'd1) & (icmp_ln142_reg_592 == 1'd0) & (icmp_ln139_reg_588 == 1'd0) & (1'd0 == and_ln60_reg_559) & (icmp_ln60_9_reg_563 == 1'd0))) | ((icmp_ln60_reg_555 == 1'd0) & (tmp_94_reg_596 == 1'd1) & (icmp_ln142_reg_592 == 1'd0) & (icmp_ln139_reg_588 == 1'd0) & (1'd0 == and_ln60_2_reg_577))) | ((icmp_ln60_reg_555 == 1'd0) & (tmp_94_reg_596 == 1'd1) & (icmp_ln142_reg_592 == 1'd0) & (icmp_ln139_reg_588 == 1'd0) & (icmp_ln60_9_reg_563 == 1'd0))))) begin
...
always @ (*) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state3) | ((icmp_ln60_fu_289_p2 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (((icmp_ln60_reg_555 == 1'd0) & (icmp_ln60_9_fu_336_p2 == 1'd0)) | ((1'd0 == and_ln60_fu_330_p2) & (icmp_ln60_9_fu_336_p2 == 1'd0))))) begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end else if (((1'b1 == ap_CS_fsm_state2) & (((icmp_ln60_reg_555 == 1'd0) & (icmp_ln60_9_fu_336_p2 == 1'd1)) | ((1'd0 == and_ln60_fu_330_p2) & (icmp_ln60_9_fu_336_p2 == 1'd1))))) begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (((tmp_94_fu_401_p3 == 1'd1) & (icmp_ln142_fu_395_p2 == 1'd0) & (icmp_ln139_fu_389_p2 == 1'd0) & (icmp_ln60_9_reg_563 == 1'd0)) | ((tmp_94_fu_401_p3 == 1'd1) & (icmp_ln142_fu_395_p2 == 1'd0) & (icmp_ln139_fu_389_p2 == 1'd0) & (1'd0 == and_ln60_2_fu_375_p2))))) begin
                ap_NS_fsm = ap_ST_fsm_state7;
            end else if (((1'b1 == ap_CS_fsm_state4) & (((tmp_94_fu_401_p3 == 1'd0) & (icmp_ln142_fu_395_p2 == 1'd0) & (icmp_ln139_fu_389_p2 == 1'd0) & (icmp_ln60_9_reg_563 == 1'd0)) | ((tmp_94_fu_401_p3 == 1'd0) & (icmp_ln142_fu_395_p2 == 1'd0) & (icmp_ln139_fu_389_p2 == 1'd0) & (1'd0 == and_ln60_2_fu_375_p2))))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else if (((1'b1 == ap_CS_fsm_state4) & (((icmp_ln142_fu_395_p2 == 1'd1) & (icmp_ln139_fu_389_p2 == 1'd0) & (icmp_ln60_9_reg_563 == 1'd0)) | ((icmp_ln142_fu_395_p2 == 1'd1) & (icmp_ln139_fu_389_p2 == 1'd0) & (1'd0 == and_ln60_2_fu_375_p2))))) begin
...
assign add_ln131_1_fu_278_p2 = (sub_ln131_fu_256_p2 + 13'd2);

assign add_ln131_fu_267_p2 = (sub_ln131_fu_256_p2 + 13'd1);

assign and_ln60_2_fu_375_p2 = (or_ln60_1_fu_371_p2 & grp_fu_4230_p_dout0);

assign and_ln60_fu_330_p2 = (or_ln60_fu_324_p2 & grp_fu_4230_p_dout0);
...
assign bitcast_ln60_1_fu_341_p1 = b_num_q0;

assign bitcast_ln60_fu_295_p1 = p_read3;

assign diff_p_fu_381_p2 = (this_p_read - b_p_read);

assign grp_fu_12738_p_ce = grp_fu_221_ce;

assign grp_fu_12738_p_din0 = grp_fu_221_p0;

assign grp_fu_12738_p_din1 = grp_fu_221_p1;

assign grp_fu_12738_p_opcode = 2'd0;

assign grp_fu_4230_p_ce = grp_fu_226_ce;

assign grp_fu_4230_p_din0 = grp_fu_226_p0;

assign grp_fu_4230_p_din1 = grp_fu_226_p1;

assign grp_fu_4230_p_opcode = grp_fu_226_opcode;

assign grp_p_sum_2_fu_209_ap_start = grp_p_sum_2_fu_209_ap_start_reg;

assign icmp_ln139_fu_389_p2 = (($signed(diff_p_fu_381_p2) > $signed(32'd2)) ? 1'b1 : 1'b0);

assign icmp_ln142_fu_395_p2 = (($signed(diff_p_fu_381_p2) < $signed(32'd4294967294)) ? 1'b1 : 1'b0);

assign icmp_ln60_10_fu_359_p2 = ((tmp_83_fu_345_p4 != 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln60_11_fu_365_p2 = ((trunc_ln60_1_fu_355_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln60_7_fu_312_p2 = ((tmp_fu_298_p4 != 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln60_8_fu_318_p2 = ((trunc_ln60_fu_308_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln60_9_fu_336_p2 = ((b_p_read == 32'd0) ? 1'b1 : 1'b0);

assign icmp_ln60_fu_289_p2 = ((this_p_read == 32'd0) ? 1'b1 : 1'b0);

assign or_ln60_1_fu_371_p2 = (icmp_ln60_11_reg_572 | icmp_ln60_10_reg_567);

assign or_ln60_fu_324_p2 = (icmp_ln60_8_fu_318_p2 | icmp_ln60_7_fu_312_p2);

assign select_ln115_fu_441_p3 = ((trunc_ln115_fu_438_p1[0:0] == 1'b1) ? p_read3 : p_read14);

assign sub_ln115_fu_425_p2 = (2'd0 - trunc_ln136_reg_581);

assign sub_ln131_fu_256_p2 = (tmp_119_cast_fu_248_p3 - zext_ln131_fu_240_p1);

assign tmp_119_cast_fu_248_p3 = {{trunc_ln131_fu_244_p1}, {2'd0}};

assign tmp_83_fu_345_p4 = {{bitcast_ln60_1_fu_341_p1[30:23]}};

assign tmp_86_fu_453_p4 = (trunc_ln136_reg_581 ^ 2'd2);

assign tmp_94_fu_401_p3 = diff_p_fu_381_p2[32'd31];

assign tmp_fu_298_p4 = {{bitcast_ln60_fu_295_p1[30:23]}};

assign trunc_ln115_fu_438_p1 = sub_ln115_reg_620[0:0];

assign trunc_ln131_fu_244_p1 = b_num_offset[10:0];

assign trunc_ln136_fu_385_p1 = diff_p_fu_381_p2[1:0];

assign trunc_ln60_1_fu_355_p1 = bitcast_ln60_1_fu_341_p1[22:0];

assign trunc_ln60_fu_308_p1 = bitcast_ln60_fu_295_p1[22:0];

assign zext_ln131_1_fu_262_p1 = sub_ln131_fu_256_p2;

assign zext_ln131_2_fu_273_p1 = add_ln131_fu_267_p2;

assign zext_ln131_3_fu_284_p1 = add_ln131_1_fu_278_p2;

assign zext_ln131_fu_240_p1 = b_num_offset;
