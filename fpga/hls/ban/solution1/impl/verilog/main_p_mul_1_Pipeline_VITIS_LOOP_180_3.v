...
module main_p_mul_1_Pipeline_VITIS_LOOP_180_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln180_fu_154_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg   [1:0] i_reg_276;
wire    ap_block_pp0_stage0_11001;
wire   [63:0] trunc_ln181_cast_fu_166_p1;
wire    ap_block_pp0_stage0;
reg   [1:0] i_2_fu_48;
wire   [1:0] add_ln180_fu_160_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln180_fu_154_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln180_fu_154_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln180_fu_154_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln180_fu_160_p2 = (ap_sig_allocacmp_i + 2'd1);
...
assign aux_address0 = trunc_ln181_cast_fu_166_p1;

assign icmp_ln180_fu_154_p2 = ((ap_sig_allocacmp_i == 2'd3) ? 1'b1 : 1'b0);
...
assign trunc_ln181_cast_fu_166_p1 = ap_sig_allocacmp_i;
...
endmodule //main_p_mul_1_Pipeline_VITIS_LOOP_180_3
