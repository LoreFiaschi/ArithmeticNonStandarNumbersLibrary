...
module main_main_Pipeline_VITIS_LOOP_185_173 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln185_fu_213_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg   [1:0] i_57_reg_338;
wire    ap_block_pp0_stage0_11001;
wire   [63:0] trunc_ln186_3_cast_fu_225_p1;
wire    ap_block_pp0_stage0;
reg   [1:0] i_fu_56;
wire   [1:0] add_ln185_fu_219_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln185_fu_213_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln185_fu_213_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln185_fu_213_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln185_fu_219_p2 = (ap_sig_allocacmp_i_57 + 2'd1);
...
assign aux_address0 = trunc_ln186_3_cast_fu_225_p1;
...
assign icmp_ln185_fu_213_p2 = ((ap_sig_allocacmp_i_57 == 2'd3) ? 1'b1 : 1'b0);

assign trunc_ln186_3_cast_fu_225_p1 = ap_sig_allocacmp_i_57;

endmodule //main_main_Pipeline_VITIS_LOOP_185_173
