...
entity main_p_sum_Pipeline_VITIS_LOOP_90_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    p_reload5 : IN STD_LOGIC_VECTOR (31 downto 0);
...
architecture behav of main_p_sum_Pipeline_VITIS_LOOP_90_2 is 
...
attribute shreg_extract : string;
    ...
    signal tmp_6_fu_159_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal empty_20_fu_56 : STD_LOGIC_VECTOR (31 downto 0);
    signal empty_21_fu_60 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_fu_159_p4 : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    mux_32_32_1_1_U23 : component main_mux_32_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    empty_20_fu_56_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
    ...
    empty_21_fu_60_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
    ...
    tmp_6_fu_159_p4 <= idx_fu_48(2 - 1 downto 0);
