...
entity main_operator_Pipeline_VITIS_LOOP_90_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of main_operator_Pipeline_VITIS_LOOP_90_2 is 
...
attribute shreg_extract : string;
    ...
    signal base_1_fu_44 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal empty_16_fu_56 : STD_LOGIC_VECTOR (31 downto 0);
    signal empty_17_fu_60 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    base_1_fu_44_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    base_1_fu_44 <= ap_const_lv2_0;
                elsif (((icmp_ln90_fu_126_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    base_1_fu_44 <= add_ln91_2_fu_131_p2;
                end if;
            end if; 
        end if;
    end process;

    empty_16_fu_56_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    empty_16_fu_56 <= agg_result_113_0_reload;
                elsif ((ap_const_boolean_1 = ap_condition_169)) then 
                    empty_16_fu_56 <= tmp_s_fu_159_p5;
                end if;
            end if; 
        end if;
    end process;

    empty_17_fu_60_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    empty_17_fu_60 <= agg_result_12_0_reload;
                elsif ((ap_const_boolean_1 = ap_condition_173)) then 
                    empty_17_fu_60 <= tmp_s_fu_159_p5;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    empty_fu_52 <= agg_result_1_0_reload;
    ...
    add_ln91_2_fu_131_p2 <= std_logic_vector(unsigned(base_1_fu_44) + unsigned(ap_const_lv2_1));
    ...
    begin
                ap_condition_169 <= ((base_load_fu_123_p1 = ap_const_lv2_1) and (icmp_ln90_fu_126_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_condition_173_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln90_fu_126_p2, base_load_fu_123_p1)
    begin
                ap_condition_173 <= (not((base_load_fu_123_p1 = ap_const_lv2_1)) and not((base_load_fu_123_p1 = ap_const_lv2_0)) and (icmp_ln90_fu_126_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_condition_176_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln90_fu_126_p2, base_load_fu_123_p1)
    begin
                ap_condition_176 <= ((base_load_fu_123_p1 = ap_const_lv2_0) and (icmp_ln90_fu_126_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;
    ...
    base_load_fu_123_p1 <= base_1_fu_44;
    icmp_ln90_fu_126_p2 <= "1" when (base_1_fu_44 = xor_ln90) else "0";
