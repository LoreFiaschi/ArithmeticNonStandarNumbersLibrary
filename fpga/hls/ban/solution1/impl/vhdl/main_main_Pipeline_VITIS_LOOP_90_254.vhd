...
entity main_main_Pipeline_VITIS_LOOP_90_254 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    zext_ln90_9 : IN STD_LOGIC_VECTOR (1 downto 0);
    select_ln90_6 : IN STD_LOGIC_VECTOR (1 downto 0);
...
architecture behav of main_main_Pipeline_VITIS_LOOP_90_254 is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln90_9_cast_fu_103_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal zext_ln91_fu_144_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln91_14_fu_148_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln91_8_fu_157_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln91_15_fu_161_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    add_ln91_14_fu_148_p2 <= std_logic_vector(unsigned(sub_ln535) + unsigned(zext_ln91_fu_144_p1));
    add_ln91_15_fu_161_p2 <= std_logic_vector(unsigned(sub_ln535) + unsigned(zext_ln91_8_fu_157_p1));
    ...
    b_num_address0 <= zext_ln91_7_reg_259(6 - 1 downto 0);
    b_num_address1 <= zext_ln91_9_fu_166_p1(6 - 1 downto 0);
    ...
    icmp_ln90_fu_130_p2 <= "1" when (base_fu_52 = select_ln90_6) else "0";
    reuse_select_fu_204_p3 <= 
        reuse_reg_fu_48 when (addr_cmp_reg_269(0) = '1') else 
        b_num_q1;
    zext_ln90_9_cast_fu_103_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln90_9),3));
    zext_ln91_7_fu_153_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln91_14_fu_148_p2),64));
    zext_ln91_8_fu_157_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(idx_fu_56),6));
    zext_ln91_9_fu_166_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln91_15_fu_161_p2),64));
