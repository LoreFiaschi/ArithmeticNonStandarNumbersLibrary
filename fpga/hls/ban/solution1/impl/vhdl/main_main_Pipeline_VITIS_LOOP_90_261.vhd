...
entity main_main_Pipeline_VITIS_LOOP_90_261 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    zext_ln90_11 : IN STD_LOGIC_VECTOR (1 downto 0);
    select_ln90_8 : IN STD_LOGIC_VECTOR (1 downto 0);
...
architecture behav of main_main_Pipeline_VITIS_LOOP_90_261 is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln90_11_cast_fu_103_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal zext_ln91_fu_144_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln91_8_fu_148_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln91_2_fu_157_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln91_9_fu_161_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    idx_fu_56 <= zext_ln90_11_cast_fu_103_p1;
                elsif (((icmp_ln90_fu_130_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    idx_fu_56 <= add_ln91_10_fu_171_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln91_10_fu_171_p2 <= std_logic_vector(unsigned(idx_fu_56) + unsigned(ap_const_lv3_1));
    add_ln91_8_fu_148_p2 <= std_logic_vector(unsigned(sub_ln535) + unsigned(zext_ln91_fu_144_p1));
    add_ln91_9_fu_161_p2 <= std_logic_vector(unsigned(sub_ln535) + unsigned(zext_ln91_2_fu_157_p1));
    ...
    b_num_address0 <= zext_ln91_1_reg_259(6 - 1 downto 0);
    b_num_address1 <= zext_ln91_3_fu_166_p1(6 - 1 downto 0);
    ...
    icmp_ln90_fu_130_p2 <= "1" when (base_fu_52 = select_ln90_8) else "0";
    reuse_select_fu_204_p3 <= 
        reuse_reg_fu_48 when (addr_cmp_reg_269(0) = '1') else 
        b_num_q1;
    zext_ln90_11_cast_fu_103_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln90_11),3));
    zext_ln91_1_fu_153_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln91_8_fu_148_p2),64));
    zext_ln91_2_fu_157_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(idx_fu_56),6));
    zext_ln91_3_fu_166_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln91_9_fu_161_p2),64));
