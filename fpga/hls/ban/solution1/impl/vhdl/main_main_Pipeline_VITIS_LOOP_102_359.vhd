...
entity main_main_Pipeline_VITIS_LOOP_102_359 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    zext_ln102_18 : IN STD_LOGIC_VECTOR (1 downto 0);
    select_ln102_10 : IN STD_LOGIC_VECTOR (2 downto 0);
...
architecture behav of main_main_Pipeline_VITIS_LOOP_102_359 is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln102_18_cast_fu_70_p1 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                if ((icmp_ln102_fu_82_p2 = ap_const_lv1_1)) then 
                    base_fu_34 <= add_ln103_2_fu_103_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    base_fu_34 <= zext_ln102_18_cast_fu_70_p1;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln103_2_fu_103_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_base_25) + unsigned(ap_const_lv3_1));
    ...
    ap_sig_allocacmp_base_25_assign_proc : process(ap_CS_fsm_state1, base_fu_34, zext_ln102_18_cast_fu_70_p1, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_sig_allocacmp_base_25 <= zext_ln102_18_cast_fu_70_p1;
        else 
    ...
    icmp_ln102_fu_82_p2 <= "1" when (unsigned(ap_sig_allocacmp_base_25) < unsigned(select_ln102_10)) else "0";
    zext_ln102_18_cast_fu_70_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln102_18),3));
    zext_ln103_2_fu_98_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln103_fu_92_p2),64));
    zext_ln103_fu_88_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_base_25),6));
end behav;
