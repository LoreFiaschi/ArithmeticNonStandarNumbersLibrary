...
entity main_main_Pipeline_VITIS_LOOP_102_350 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    zext_ln102_6 : IN STD_LOGIC_VECTOR (1 downto 0);
    select_ln102_3 : IN STD_LOGIC_VECTOR (2 downto 0);
...
architecture behav of main_main_Pipeline_VITIS_LOOP_102_350 is 
...
attribute shreg_extract : string;
    ...
    signal base_19_fu_34 : STD_LOGIC_VECTOR (2 downto 0);
    signal zext_ln102_6_cast_fu_70_p1 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    base_19_fu_34_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                if ((icmp_ln102_fu_82_p2 = ap_const_lv1_1)) then 
                    base_19_fu_34 <= add_ln103_3_fu_103_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    base_19_fu_34 <= zext_ln102_6_cast_fu_70_p1;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln103_3_fu_103_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_base) + unsigned(ap_const_lv3_1));
    ...
    ap_sig_allocacmp_base_assign_proc : process(ap_CS_fsm_state1, base_19_fu_34, zext_ln102_6_cast_fu_70_p1, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_sig_allocacmp_base <= zext_ln102_6_cast_fu_70_p1;
        else 
            ap_sig_allocacmp_base <= base_19_fu_34;
        end if; 
    end process;
    ...
    icmp_ln102_fu_82_p2 <= "1" when (unsigned(ap_sig_allocacmp_base) < unsigned(select_ln102_3)) else "0";
    zext_ln102_6_cast_fu_70_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln102_6),3));
