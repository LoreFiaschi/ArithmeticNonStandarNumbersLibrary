...
entity main_operator_1_Pipeline_VITIS_LOOP_90_2_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of main_operator_1_Pipeline_VITIS_LOOP_90_2_s is 
...
attribute shreg_extract : string;
    ...
    signal base_12_load_fu_123_p1 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal b_12_2_fu_56 : STD_LOGIC_VECTOR (31 downto 0);
    signal b_112_2_fu_60 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    mux_32_32_1_1_U609 : component main_mux_32_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    b_112_2_fu_60_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    b_112_2_fu_60 <= b_112_0_reload;
                elsif ((ap_const_boolean_1 = ap_condition_168)) then 
                    b_112_2_fu_60 <= tmp_s_fu_159_p5;
                end if;
            end if; 
        end if;
    end process;

    b_12_2_fu_56_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    b_12_2_fu_56 <= b_12_0_reload;
                elsif ((ap_const_boolean_1 = ap_condition_172)) then 
                    b_12_2_fu_56 <= tmp_s_fu_159_p5;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    base_fu_44 <= add_ln91_12_fu_131_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln91_12_fu_131_p2 <= std_logic_vector(unsigned(base_fu_44) + unsigned(ap_const_lv2_1));
    ...
    ap_condition_168_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln90_fu_126_p2, base_12_load_fu_123_p1)
    begin
                ap_condition_168 <= ((base_12_load_fu_123_p1 = ap_const_lv2_1) and (icmp_ln90_fu_126_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_condition_172_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln90_fu_126_p2, base_12_load_fu_123_p1)
    begin
                ap_condition_172 <= (not((base_12_load_fu_123_p1 = ap_const_lv2_1)) and not((base_12_load_fu_123_p1 = ap_const_lv2_0)) and (icmp_ln90_fu_126_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_condition_176_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln90_fu_126_p2, base_12_load_fu_123_p1)
    begin
                ap_condition_176 <= ((base_12_load_fu_123_p1 = ap_const_lv2_0) and (icmp_ln90_fu_126_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;
    ...
    base_12_load_fu_123_p1 <= base_fu_44;
