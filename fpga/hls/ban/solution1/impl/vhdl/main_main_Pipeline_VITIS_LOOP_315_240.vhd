...
entity main_main_Pipeline_VITIS_LOOP_315_240 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of main_main_Pipeline_VITIS_LOOP_315_240 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln315_fu_137_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln316_fu_149_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln316_reg_255 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln316_reg_255_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln316_reg_255_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln316_reg_255_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln319_fu_155_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln319_reg_260 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal tmp_142_fu_175_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln316_fu_184_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln316_reg_276 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln317_1_fu_198_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal i_fu_54 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln315_fu_143_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_37 : STD_LOGIC_VECTOR (1 downto 0);
    signal zext_ln317_fu_190_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln317_fu_193_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    mux_32_32_1_1_U490 : component main_mux_32_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    mux_32_32_1_1_U491 : component main_mux_32_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln315_fu_137_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln315_fu_137_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln315_fu_143_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_37) + unsigned(ap_const_lv2_1));
    add_ln317_fu_193_p2 <= std_logic_vector(unsigned(sub_ln542) + unsigned(zext_ln317_fu_190_p1));
    add_ln319_fu_155_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_37) + unsigned(trunc_ln297_3));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln315_fu_137_p2)
    begin
        if (((icmp_ln315_fu_137_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    b_num_address0 <= zext_ln317_1_fu_198_p1(6 - 1 downto 0);
    ...
    grp_fu_12725_p_din0 <= tmp_s_fu_166_p5;
    grp_fu_12725_p_din1 <= tmp_142_fu_175_p5;
    grp_fu_12725_p_opcode <= ap_const_lv2_0;
    icmp_ln315_fu_137_p2 <= "1" when (ap_sig_allocacmp_i_37 = ap_const_lv2_3) else "0";
    icmp_ln316_fu_149_p2 <= "1" when (unsigned(ap_sig_allocacmp_i_37) < unsigned(sub11_i_i)) else "0";
    select_ln316_fu_184_p3 <= 
        tmp_s_reg_265_pp0_iter3_reg when (icmp_ln316_reg_255_pp0_iter3_reg(0) = '1') else 
        grp_fu_12725_p_dout0;
    zext_ln317_1_fu_198_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln317_fu_193_p2),64));
    zext_ln317_fu_190_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_37_reg_245_pp0_iter4_reg),6));
end behav;
