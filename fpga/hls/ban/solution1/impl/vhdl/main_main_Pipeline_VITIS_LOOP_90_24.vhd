...
entity main_main_Pipeline_VITIS_LOOP_90_24 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of main_main_Pipeline_VITIS_LOOP_90_24 is 
...
attribute shreg_extract : string;
    ...
    signal add_ln91_fu_131_p2 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal bb4_num_1_fu_52 : STD_LOGIC_VECTOR (31 downto 0);
    signal bb4_num_1_4_fu_159_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal bb4_num_1_1_fu_56 : STD_LOGIC_VECTOR (31 downto 0);
    signal bb4_num_1_2_fu_60 : STD_LOGIC_VECTOR (31 downto 0);
    signal bb4_num_1_4_fu_159_p4 : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    mux_32_32_1_1_U125 : component main_mux_32_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
        ...
        dout_WIDTH => 32)
    port map (
        din0 => bb4_num_1_fu_52,
        din1 => bb4_num_1_1_fu_56,
        din2 => bb4_num_1_2_fu_60,
        din3 => bb4_num_1_4_fu_159_p4,
        dout => bb4_num_1_4_fu_159_p5);
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    base_fu_44 <= add_ln91_fu_131_p2;
                end if;
            end if; 
        end if;
    end process;

    bb4_num_1_1_fu_56_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    bb4_num_1_1_fu_56 <= tmp_23;
                elsif ((ap_const_boolean_1 = ap_condition_169)) then 
                    bb4_num_1_1_fu_56 <= bb4_num_1_4_fu_159_p5;
                end if;
            end if; 
        end if;
    end process;

    bb4_num_1_2_fu_60_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    bb4_num_1_2_fu_60 <= tmp_24;
                elsif ((ap_const_boolean_1 = ap_condition_173)) then 
                    bb4_num_1_2_fu_60 <= bb4_num_1_4_fu_159_p5;
                end if;
            end if; 
        end if;
    end process;

    bb4_num_1_fu_52_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    bb4_num_1_fu_52 <= tmp_22;
                elsif ((ap_const_boolean_1 = ap_condition_176)) then 
                    bb4_num_1_fu_52 <= bb4_num_1_4_fu_159_p5;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    idx_fu_48 <= zext_ln90_1_cast_fu_94_p1;
                elsif (((icmp_ln90_fu_126_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    idx_fu_48 <= add_ln91_2_fu_149_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln91_2_fu_149_p2 <= std_logic_vector(unsigned(idx_fu_48) + unsigned(ap_const_lv3_1));
    add_ln91_fu_131_p2 <= std_logic_vector(unsigned(base_fu_44) + unsigned(ap_const_lv2_1));
    ...
    bb4_num_1_4_fu_159_p4 <= idx_fu_48(2 - 1 downto 0);
