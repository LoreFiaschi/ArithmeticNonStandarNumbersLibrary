...
entity main_p_mul_1_Pipeline_VITIS_LOOP_180_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of main_p_mul_1_Pipeline_VITIS_LOOP_180_3 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln180_fu_154_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal i_reg_276 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal trunc_ln181_cast_fu_166_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal i_2_fu_48 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln180_fu_160_p2 : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln180_fu_154_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_2_fu_48 <= add_ln180_fu_160_p2;
    ...
    add_ln180_fu_160_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv2_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln180_fu_154_p2)
    begin
        if (((icmp_ln180_fu_154_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    aux_address0 <= trunc_ln181_cast_fu_166_p1(3 - 1 downto 0);
    ...
    icmp_ln180_fu_154_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv2_3) else "0";
    num_res5_07_out <= num_res5_07_fu_64;

    num_res5_07_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln180_fu_154_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln180_fu_154_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    num_res6_06_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln180_fu_154_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln180_fu_154_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    num_res_08_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln180_fu_154_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln180_fu_154_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    trunc_ln181_cast_fu_166_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i),64));
    write_flag5_0_out <= write_flag5_0_fu_72;

    write_flag5_0_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln180_fu_154_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln180_fu_154_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    write_flag8_0_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln180_fu_154_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln180_fu_154_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    write_flag_0_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln180_fu_154_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln180_fu_154_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
