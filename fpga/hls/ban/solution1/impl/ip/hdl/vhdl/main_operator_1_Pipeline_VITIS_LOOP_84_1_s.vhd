...
entity main_operator_1_Pipeline_VITIS_LOOP_84_1_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of main_operator_1_Pipeline_VITIS_LOOP_84_1_s is 
...
attribute shreg_extract : string;
    ...
    signal idx_14_fu_48 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal tmp_36_fu_134_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    mux_32_32_1_1_U828 : component main_mux_32_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    and_ln85_fu_177_p2 <= (or_ln85_fu_173_p2 and grp_fu_1048_p_dout0);
    ...
    grp_fu_1048_p_din0 <= tmp_s_fu_120_p5;
    grp_fu_1048_p_din1 <= ap_const_lv32_0;
    grp_fu_1048_p_opcode <= ap_const_lv5_1;
    icmp_ln84_fu_99_p2 <= "1" when (idx_14_fu_48 = ap_const_lv2_3) else "0";
    icmp_ln85_1_fu_148_p2 <= "0" when (tmp_36_fu_134_p4 = ap_const_lv8_FF) else "1";
    ...
    idx_18_fu_160_p3 <= 
        idx_19_fu_114_p2 when (icmp_ln85_fu_108_p2(0) = '1') else 
        idx_14_fu_48;
    idx_19_fu_114_p2 <= std_logic_vector(unsigned(idx_14_fu_48) + unsigned(ap_const_lv2_1));
    idx_20_fu_205_p3 <= 
        zext_ln81_fu_201_p1 when (icmp_ln85_reg_258(0) = '1') else 
        idx_tmp_load_3_reg_253;
    idx_fu_194_p3 <= 
        idx_19_reg_264 when (and_ln85_1_fu_189_p2(0) = '1') else 
        ap_const_lv2_0;
    ...
    tmp_36_fu_134_p4 <= bitcast_ln85_fu_130_p1(30 downto 23);
