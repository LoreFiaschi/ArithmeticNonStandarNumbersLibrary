...
module main_operator_1_Pipeline_VITIS_LOOP_84_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign and_ln85_fu_177_p2 = (or_ln85_fu_173_p2 & grp_fu_1048_p_dout0);
...
assign grp_fu_1048_p_din0 = tmp_s_fu_120_p5;

assign grp_fu_1048_p_din1 = 32'd0;

assign grp_fu_1048_p_opcode = 5'd1;

assign icmp_ln84_fu_99_p2 = ((idx_14_fu_48 == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln85_1_fu_148_p2 = ((tmp_36_fu_134_p4 != 8'd255) ? 1'b1 : 1'b0);
...
assign idx_18_fu_160_p3 = ((icmp_ln85_fu_108_p2[0:0] == 1'b1) ? idx_19_fu_114_p2 : idx_14_fu_48);

assign idx_19_fu_114_p2 = (idx_14_fu_48 + 2'd1);

assign idx_20_fu_205_p3 = ((icmp_ln85_reg_258[0:0] == 1'b1) ? zext_ln81_fu_201_p1 : idx_tmp_load_3_reg_253);

assign idx_fu_194_p3 = ((and_ln85_1_fu_189_p2[0:0] == 1'b1) ? idx_19_reg_264 : 2'd0);

assign idx_tmp_out = idx_tmp_fu_52;

assign or_ln85_fu_173_p2 = (icmp_ln85_2_reg_279 | icmp_ln85_1_reg_274);

assign tmp_36_fu_134_p4 = {{bitcast_ln85_fu_130_p1[30:23]}};
...
endmodule //main_operator_1_Pipeline_VITIS_LOOP_84_1_s
