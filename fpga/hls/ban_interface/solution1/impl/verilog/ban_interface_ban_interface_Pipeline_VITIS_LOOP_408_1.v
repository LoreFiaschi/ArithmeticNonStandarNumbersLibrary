...
module ban_interface_ban_interface_Pipeline_VITIS_LOOP_408_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [31:0] bitcast_ln409_out;
output   bitcast_ln409_out_ap_vld;
output  [0:0] or_ln409_out;
output   or_ln409_out_ap_vld;
...
reg ap_idle;
reg ap_ready;
reg bitcast_ln409_out_ap_vld;
reg or_ln409_out_ap_vld;
reg[0:0] ap_return;
...
wire   [0:0] and_ln409_3_fu_257_p2;
wire   [6:0] shl_ln5_fu_127_p3;
wire   [6:0] add_ln409_1_fu_141_p2;
wire   [7:0] zext_ln409_3_fu_151_p1;
wire   [7:0] add_ln409_2_fu_155_p2;
wire   [127:0] zext_ln409_5_fu_161_p1;
...
wire   [22:0] trunc_ln409_4_fu_235_p1;
wire   [0:0] icmp_ln409_4_fu_245_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_15_fu_72 <= 2'd1;
    end else if (((1'd1 == and_ln409_3_fu_257_p2) & (icmp_ln408_reg_289 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if (((icmp_ln408_reg_289 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        bitcast_ln409_out_ap_vld = 1'b1;
    end else begin
        bitcast_ln409_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln408_reg_289 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        or_ln409_out_ap_vld = 1'b1;
    end else begin
        or_ln409_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((1'd1 == and_ln409_3_fu_257_p2) & (icmp_ln408_reg_289 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
...
assign add_ln408_fu_262_p2 = (i_reg_284 + 2'd1);

assign add_ln409_1_fu_141_p2 = (shl_ln5_fu_127_p3 + 7'd63);

assign add_ln409_2_fu_155_p2 = (zext_ln409_3_fu_151_p1 + 8'd1);

assign add_ln409_fu_135_p2 = (shl_ln5_fu_127_p3 + 7'd32);

assign and_ln409_3_fu_257_p2 = (or_ln409_reg_309 & grp_fu_7617_p_dout0);
...
assign bitcast_ln409_out = bitcast_ln409_reg_303;
...
assign icmp_ln408_fu_121_p2 = ((i_15_fu_72 == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln409_4_fu_245_p2 = ((trunc_ln409_4_fu_235_p1 == 23'd0) ? 1'b1 : 1'b0);
...
assign or_ln409_fu_251_p2 = (icmp_ln409_fu_239_p2 | icmp_ln409_4_fu_245_p2);

assign or_ln409_out = or_ln409_reg_309;
...
assign shl_ln409_fu_165_p2 = 128'd1 << zext_ln409_5_fu_161_p1;

assign shl_ln5_fu_127_p3 = {{i_15_fu_72}, {5'd0}};
...
assign trunc_ln409_4_fu_235_p1 = lshr_ln409_fu_210_p2[22:0];

assign trunc_ln409_fu_216_p1 = lshr_ln409_fu_210_p2[31:0];

assign zext_ln409_1_fu_147_p1 = add_ln409_fu_135_p2;

assign zext_ln409_3_fu_151_p1 = add_ln409_1_fu_141_p2;

assign zext_ln409_5_fu_161_p1 = add_ln409_2_fu_155_p2;

assign zext_ln409_7_fu_193_p1 = shl_ln409_1_fu_187_p2;
...
endmodule //ban_interface_ban_interface_Pipeline_VITIS_LOOP_408_1
