...
module ban_interface_mul_body_Pipeline_VITIS_LOOP_21_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((i_8_load_fu_102_p1 == 2'd1) & (icmp_ln21_fu_105_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        agg_result_num12_0_fu_50 <= tmp_s_fu_117_p5;
    end
end

always @ (posedge ap_clk) begin
    if ((~(i_8_load_fu_102_p1 == 2'd1) & ~(i_8_load_fu_102_p1 == 2'd0) & (icmp_ln21_fu_105_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        agg_result_num2_0_fu_46 <= tmp_s_fu_117_p5;
    end
end

always @ (posedge ap_clk) begin
    if (((i_8_load_fu_102_p1 == 2'd0) & (icmp_ln21_fu_105_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
assign add_ln21_fu_111_p2 = (ap_sig_allocacmp_i_8 + 2'd1);
...
assign i_8_load_fu_102_p1 = ap_sig_allocacmp_i_8;

assign icmp_ln21_fu_105_p2 = ((ap_sig_allocacmp_i_8 == 2'd3) ? 1'b1 : 1'b0);

endmodule //ban_interface_mul_body_Pipeline_VITIS_LOOP_21_1
