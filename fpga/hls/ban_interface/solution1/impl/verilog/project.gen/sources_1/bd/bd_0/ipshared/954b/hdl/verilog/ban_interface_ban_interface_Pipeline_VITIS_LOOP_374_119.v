...
output  [0:0] res_17_out;
output   res_17_out_ap_vld;
...
wire   [0:0] res_12_fu_304_p2;
wire   [0:0] solved_6_fu_310_p2;
...
always @ (*) begin
    if (((icmp_ln374_reg_323 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        res_17_out_ap_vld = 1'b1;
    end else begin
        res_17_out_ap_vld = 1'b0;
    end
end
...
assign and_ln375_2_fu_276_p2 = (or_ln375_reg_332_pp0_iter1_reg & grp_fu_7441_p_dout0);
...
assign res_12_fu_304_p2 = (sel_tmp159_fu_298_p2 | res_reg_95);

assign res_17_out = res_reg_95;

assign sel_tmp159_fu_298_p2 = (xor_ln375_fu_292_p2 & and_ln377_fu_281_p2);
...
assign solved_6_fu_310_p2 = (xor_ln375_fu_292_p2 | solved_reg_83);
