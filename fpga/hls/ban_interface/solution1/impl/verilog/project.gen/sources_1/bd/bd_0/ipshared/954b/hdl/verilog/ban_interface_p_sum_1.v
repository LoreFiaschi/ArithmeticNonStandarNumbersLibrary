...
always @ (posedge ap_clk) begin
    if (((tmp_241_fu_369_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        agg_result_num16_6_reg_142 <= bitcast_ln111_1_reg_653;
    end else if (((tmp_241_reg_669 == 1'd0) & (1'b1 == ap_CS_fsm_state7))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state11) | ((tmp_241_reg_669 == 1'd0) & (1'b1 == ap_CS_fsm_state7)))) begin
...
assign icmp_ln77_9_fu_418_p2 = ((tmp_227_fu_404_p4 != 8'd255) ? 1'b1 : 1'b0);
...
assign tmp_227_fu_404_p4 = {{bitcast_ln77_fu_400_p1[30:23]}};

assign tmp_241_fu_369_p3 = diff_p[32'd1];
