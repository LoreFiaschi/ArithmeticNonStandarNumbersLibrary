...
module ban_interface_operator_Pipeline_VITIS_LOOP_84_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign and_ln85_fu_177_p2 = (or_ln85_fu_173_p2 & grp_fu_908_p_dout0);
...
assign grp_fu_908_p_din0 = tmp_s_fu_120_p5;

assign grp_fu_908_p_din1 = 32'd0;

assign grp_fu_908_p_opcode = 5'd1;

assign icmp_ln84_fu_99_p2 = ((idx_20_fu_48 == 2'd3) ? 1'b1 : 1'b0);
...
assign idx_24_fu_160_p3 = ((icmp_ln85_fu_108_p2[0:0] == 1'b1) ? idx_25_fu_114_p2 : idx_20_fu_48);

assign idx_25_fu_114_p2 = (idx_20_fu_48 + 2'd1);

assign idx_26_fu_205_p3 = ((icmp_ln85_reg_258[0:0] == 1'b1) ? zext_ln81_fu_201_p1 : idx_tmp_load_4_reg_253);

assign idx_fu_194_p3 = ((and_ln85_3_fu_189_p2[0:0] == 1'b1) ? idx_25_reg_264 : 2'd0);
...
endmodule //ban_interface_operator_Pipeline_VITIS_LOOP_84_1_s
