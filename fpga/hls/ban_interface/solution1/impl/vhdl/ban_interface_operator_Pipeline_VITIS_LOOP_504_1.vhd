...
entity ban_interface_operator_Pipeline_VITIS_LOOP_504_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ban_interface_operator_Pipeline_VITIS_LOOP_504_1 is 
...
attribute shreg_extract : string;
    ...
    signal add_ln504_fu_186_p2 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal icmp_ln507_fu_164_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    add_ln504_fu_186_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_6) + unsigned(ap_const_lv2_3));
    ...
    icmp_ln504_fu_116_p2 <= "1" when (ap_sig_allocacmp_i_6 = ap_const_lv2_0) else "0";
    icmp_ln506_fu_132_p2 <= "1" when (unsigned(i_cast_fu_128_p1) < unsigned(sub_i1)) else "0";
    icmp_ln507_fu_164_p2 <= "1" when (ap_sig_allocacmp_i_6 = ap_const_lv2_1) else "0";
    ...
    num_res_2_3_fu_170_p3 <= 
        num_res_1_fu_156_p3 when (icmp_ln507_fu_164_p2(0) = '1') else 
        num_res_2_1_fu_60;
    num_res_2_4_fu_178_p3 <= 
        num_res_2_fu_56 when (icmp_ln507_fu_164_p2(0) = '1') else 
        num_res_1_fu_156_p3;
    tmp_s_fu_144_p4 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_6) + unsigned(trunc_ln507_1));
end behav;
