...
entity ban_interface_ban_interface_Pipeline_VITIS_LOOP_408_122 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    bitcast_ln409_3_out : OUT STD_LOGIC_VECTOR (31 downto 0);
    bitcast_ln409_3_out_ap_vld : OUT STD_LOGIC;
    or_ln409_3_out : OUT STD_LOGIC_VECTOR (0 downto 0);
    or_ln409_3_out_ap_vld : OUT STD_LOGIC;
...
architecture behav of ban_interface_ban_interface_Pipeline_VITIS_LOOP_408_122 is 
...
attribute shreg_extract : string;
    ...
    signal i_13_reg_284 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal and_ln409_1_fu_257_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal shl_ln409_9_fu_127_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln409_1_fu_141_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln409_2_fu_151_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln409_2_fu_155_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln409_3_fu_161_p1 : STD_LOGIC_VECTOR (127 downto 0);
    ...
    signal zext_ln409_4_fu_193_p1 : STD_LOGIC_VECTOR (127 downto 0);
    ...
    signal trunc_ln409_1_fu_235_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal icmp_ln409_1_fu_245_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_lv1_1 = and_ln409_1_fu_257_p2) and (icmp_ln408_reg_289 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, icmp_ln408_reg_289, ap_CS_fsm_state4, and_ln409_1_fu_257_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((ap_const_lv1_1 = and_ln409_1_fu_257_p2) and (icmp_ln408_reg_289 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
    ...
    add_ln408_fu_262_p2 <= std_logic_vector(unsigned(i_13_reg_284) + unsigned(ap_const_lv2_1));
    add_ln409_1_fu_141_p2 <= std_logic_vector(unsigned(shl_ln409_9_fu_127_p3) + unsigned(ap_const_lv7_3F));
    add_ln409_2_fu_155_p2 <= std_logic_vector(unsigned(zext_ln409_2_fu_151_p1) + unsigned(ap_const_lv8_1));
    add_ln409_fu_135_p2 <= std_logic_vector(unsigned(shl_ln409_9_fu_127_p3) + unsigned(ap_const_lv7_20));
    and_ln409_1_fu_257_p2 <= (or_ln409_reg_309 and grp_fu_7617_p_dout0);
    ...
    bitcast_ln409_3_out <= bitcast_ln409_reg_303;

    bitcast_ln409_3_out_ap_vld_assign_proc : process(icmp_ln408_reg_289, ap_CS_fsm_state5)
    begin
        if (((icmp_ln408_reg_289 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
            bitcast_ln409_3_out_ap_vld <= ap_const_logic_1;
        else 
            bitcast_ln409_3_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    icmp_ln409_1_fu_245_p2 <= "1" when (trunc_ln409_1_fu_235_p1 = ap_const_lv23_0) else "0";
    ...
    or_ln409_3_out <= or_ln409_reg_309;

    or_ln409_3_out_ap_vld_assign_proc : process(icmp_ln408_reg_289, ap_CS_fsm_state5)
    begin
        if (((icmp_ln408_reg_289 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
            or_ln409_3_out_ap_vld <= ap_const_logic_1;
        else 
            or_ln409_3_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    or_ln409_fu_251_p2 <= (icmp_ln409_fu_239_p2 or icmp_ln409_1_fu_245_p2);
    ...
    shl_ln409_9_fu_127_p3 <= (i_fu_72 & ap_const_lv5_0);
    shl_ln409_fu_165_p2 <= std_logic_vector(shift_left(unsigned(ap_const_lv128_lc_1),to_integer(unsigned('0' & zext_ln409_3_fu_161_p1(31-1 downto 0)))));
    sub_ln409_fu_197_p2 <= std_logic_vector(unsigned(select_ln409_fu_179_p3) - unsigned(zext_ln409_4_fu_193_p1));
    tmp_fu_171_p3 <= add_ln409_2_fu_155_p2(7 downto 7);
    tmp_s_fu_225_p4 <= lshr_ln409_fu_210_p2(30 downto 23);
    trunc_ln409_1_fu_235_p1 <= lshr_ln409_fu_210_p2(23 - 1 downto 0);
    ...
    zext_ln409_2_fu_151_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln409_1_fu_141_p2),8));
    zext_ln409_3_fu_161_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln409_2_fu_155_p2),128));
    zext_ln409_4_fu_193_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln409_1_fu_187_p2),128));
