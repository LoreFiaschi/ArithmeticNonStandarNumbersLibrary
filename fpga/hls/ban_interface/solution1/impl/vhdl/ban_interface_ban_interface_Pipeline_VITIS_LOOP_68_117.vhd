...
entity ban_interface_ban_interface_Pipeline_VITIS_LOOP_68_117 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    res_11_out : OUT STD_LOGIC_VECTOR (0 downto 0);
    res_11_out_ap_vld : OUT STD_LOGIC;
...
architecture behav of ban_interface_ban_interface_Pipeline_VITIS_LOOP_68_117 is 
...
attribute shreg_extract : string;
    ...
    signal notlhs723_fu_223_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal notlhs723_reg_282 : STD_LOGIC_VECTOR (0 downto 0);
    signal notlhs723_reg_282_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal notrhs724_fu_229_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal notrhs724_reg_287 : STD_LOGIC_VECTOR (0 downto 0);
    signal notrhs724_reg_287_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal bitcast_ln69_fu_246_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal res_3_fu_260_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal shl_ln69_8_fu_113_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln69_fu_121_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln69_5_fu_127_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln69_9_fu_141_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln69_6_fu_145_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln69_10_fu_151_p1 : STD_LOGIC_VECTOR (127 downto 0);
    ...
    signal shl_ln69_3_fu_177_p2 : STD_LOGIC_VECTOR (96 downto 0);
    signal select_ln69_fu_169_p3 : STD_LOGIC_VECTOR (127 downto 0);
    signal zext_ln69_11_fu_183_p1 : STD_LOGIC_VECTOR (127 downto 0);
    signal sub_ln69_fu_187_p2 : STD_LOGIC_VECTOR (127 downto 0);
    signal and_ln69_fu_193_p2 : STD_LOGIC_VECTOR (127 downto 0);
    signal zext_ln69_5_fu_133_p1 : STD_LOGIC_VECTOR (127 downto 0);
    signal lshr_ln69_fu_199_p2 : STD_LOGIC_VECTOR (127 downto 0);
    signal tmp_s_fu_209_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_50_fu_219_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal empty_51_fu_250_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_52_fu_254_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                notlhs723_reg_282_pp0_iter1_reg <= notlhs723_reg_282;
                notrhs724_reg_287_pp0_iter1_reg <= notrhs724_reg_287;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln68_fu_107_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                notlhs723_reg_282 <= notlhs723_fu_223_p2;
                notrhs724_reg_287 <= notrhs724_fu_229_p2;
    ...
    add_ln68_fu_235_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_11) + unsigned(ap_const_lv2_1));
    add_ln69_5_fu_127_p2 <= std_logic_vector(unsigned(shl_ln69_8_fu_113_p3) + unsigned(ap_const_lv7_3F));
    add_ln69_6_fu_145_p2 <= std_logic_vector(unsigned(zext_ln69_9_fu_141_p1) + unsigned(ap_const_lv8_1));
    add_ln69_fu_121_p2 <= std_logic_vector(unsigned(shl_ln69_8_fu_113_p3) + unsigned(ap_const_lv7_20));
    ...
    ap_sig_allocacmp_i_11_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, i_fu_64)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_i_11 <= ap_const_lv2_1;
        else 
    ...
    empty_50_fu_219_p1 <= lshr_ln69_fu_199_p2(23 - 1 downto 0);
    empty_51_fu_250_p2 <= (notrhs724_reg_287_pp0_iter1_reg or notlhs723_reg_282_pp0_iter1_reg);
    empty_52_fu_254_p2 <= (grp_fu_7617_p_dout0 and empty_51_fu_250_p2);
    ...
    icmp_ln68_fu_107_p2 <= "1" when (ap_sig_allocacmp_i_11 = ap_const_lv2_3) else "0";
    lshr_ln69_fu_199_p2 <= std_logic_vector(shift_right(unsigned(and_ln69_fu_193_p2),to_integer(unsigned('0' & zext_ln69_5_fu_133_p1(31-1 downto 0)))));
    notlhs723_fu_223_p2 <= "0" when (tmp_s_fu_209_p4 = ap_const_lv8_FF) else "1";
    notrhs724_fu_229_p2 <= "1" when (empty_50_fu_219_p1 = ap_const_lv23_0) else "0";
    res_11_out <= res_reg_81;

    res_11_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln68_reg_273, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln68_reg_273 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            res_11_out_ap_vld <= ap_const_logic_1;
        else 
            res_11_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    res_3_fu_260_p2 <= (res_reg_81 and empty_52_fu_254_p2);
    select_ln69_fu_169_p3 <= 
        ap_const_lv128_lc_2 when (tmp_fu_161_p3(0) = '1') else 
        shl_ln69_fu_155_p2;
    shl_ln69_3_fu_177_p2 <= std_logic_vector(shift_left(unsigned(ap_const_lv97_1),to_integer(unsigned('0' & zext_ln69_fu_137_p1(31-1 downto 0)))));
    shl_ln69_8_fu_113_p3 <= (ap_sig_allocacmp_i_11 & ap_const_lv5_0);
    shl_ln69_fu_155_p2 <= std_logic_vector(shift_left(unsigned(ap_const_lv128_lc_1),to_integer(unsigned('0' & zext_ln69_10_fu_151_p1(31-1 downto 0)))));
    sub_ln69_fu_187_p2 <= std_logic_vector(unsigned(select_ln69_fu_169_p3) - unsigned(zext_ln69_11_fu_183_p1));
    tmp_fu_161_p3 <= add_ln69_6_fu_145_p2(7 downto 7);
    tmp_s_fu_209_p4 <= lshr_ln69_fu_199_p2(30 downto 23);
    trunc_ln69_fu_205_p1 <= lshr_ln69_fu_199_p2(32 - 1 downto 0);
    zext_ln69_10_fu_151_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln69_6_fu_145_p2),128));
    zext_ln69_11_fu_183_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln69_3_fu_177_p2),128));
    zext_ln69_5_fu_133_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln69_fu_121_p2),128));
    zext_ln69_9_fu_141_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln69_5_fu_127_p2),8));
    zext_ln69_fu_137_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln69_fu_121_p2),97));
end behav;
