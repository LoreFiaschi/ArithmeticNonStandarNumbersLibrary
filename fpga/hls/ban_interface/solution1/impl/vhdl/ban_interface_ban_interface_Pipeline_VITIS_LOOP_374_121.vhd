...
port (
    ...
    res_16_out : OUT STD_LOGIC_VECTOR (0 downto 0);
    res_16_out_ap_vld : OUT STD_LOGIC;
...
attribute shreg_extract : string;
    ...
    signal sel_tmp151_fu_298_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    and_ln375_1_fu_276_p2 <= (or_ln375_reg_332_pp0_iter1_reg and grp_fu_7617_p_dout0);
    ...
    res_16_out <= res_reg_95;

    res_16_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln374_reg_323, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln374_reg_323 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            res_16_out_ap_vld <= ap_const_logic_1;
        else 
            res_16_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    res_7_fu_304_p2 <= (sel_tmp151_fu_298_p2 or res_reg_95);
    sel_tmp151_fu_298_p2 <= (xor_ln375_fu_292_p2 and and_ln377_fu_281_p2);
    ...
    solved_1_fu_310_p2 <= (xor_ln375_fu_292_p2 or solved_reg_83);
