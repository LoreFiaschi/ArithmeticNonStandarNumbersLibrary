...
entity ban_interface_operator_2_Pipeline_VITIS_LOOP_84_1_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ban_interface_operator_2_Pipeline_VITIS_LOOP_84_1_s is 
...
begin
    fcmp_32ns_32ns_1_2_no_dsp_1_U232 : component ban_interface_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    mux_32_32_1_1_U233 : component ban_interface_mux_32_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    icmp_ln85_1_fu_148_p2 <= "0" when (tmp_7_fu_134_p4 = ap_const_lv8_FF) else "1";
    icmp_ln85_2_fu_154_p2 <= "1" when (trunc_ln85_fu_144_p1 = ap_const_lv23_0) else "0";
    icmp_ln85_fu_108_p2 <= "1" when (ap_sig_allocacmp_idx_tmp_load_2 = ap_const_lv32_0) else "0";
    idx_11_fu_160_p3 <= 
        idx_12_fu_114_p2 when (icmp_ln85_fu_108_p2(0) = '1') else 
        idx_1_fu_48;
    ...
    idx_fu_194_p3 <= 
        idx_12_reg_264 when (and_ln85_1_fu_189_p2(0) = '1') else 
        ap_const_lv2_0;
    ...
    tmp_7_fu_134_p4 <= bitcast_ln85_fu_130_p1(30 downto 23);
