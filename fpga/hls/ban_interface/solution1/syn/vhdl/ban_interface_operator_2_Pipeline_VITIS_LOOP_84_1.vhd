...
entity ban_interface_operator_2_Pipeline_VITIS_LOOP_84_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ban_interface_operator_2_Pipeline_VITIS_LOOP_84_1 is 
...
attribute shreg_extract : string;
    ...
    signal idx_tmp_load_6_reg_253 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln85_fu_108_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln85_reg_258 : STD_LOGIC_VECTOR (0 downto 0);
    signal idx_37_fu_114_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal idx_37_reg_264 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_s_fu_120_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln85_9_fu_148_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln85_9_reg_274 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln85_10_fu_154_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln85_10_reg_279 : STD_LOGIC_VECTOR (0 downto 0);
    signal idx_25_fu_48 : STD_LOGIC_VECTOR (1 downto 0);
    signal idx_36_fu_160_p3 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal idx_tmp_fu_52 : STD_LOGIC_VECTOR (31 downto 0);
    signal idx_38_fu_205_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_allocacmp_idx_tmp_load_6 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal bitcast_ln85_fu_130_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_58_fu_134_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    fcmp_32ns_32ns_1_2_no_dsp_1_U192 : component ban_interface_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    mux_32_32_1_1_U193 : component ban_interface_mux_32_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ...
                    idx_tmp_fu_52 <= idx_38_fu_205_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln84_fu_99_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln85_10_reg_279 <= icmp_ln85_10_fu_154_p2;
                icmp_ln85_9_reg_274 <= icmp_ln85_9_fu_148_p2;
                icmp_ln85_reg_258 <= icmp_ln85_fu_108_p2;
                idx_37_reg_264 <= idx_37_fu_114_p2;
                idx_tmp_load_6_reg_253 <= ap_sig_allocacmp_idx_tmp_load_6;
            end if;
        end if;
    end process;
    ...
    and_ln85_5_fu_189_p2 <= (xor_ln85_fu_183_p2 and icmp_ln85_reg_258);
    ...
    ap_sig_allocacmp_idx_tmp_load_6_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0, idx_tmp_fu_52, idx_38_fu_205_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            ap_sig_allocacmp_idx_tmp_load_6 <= idx_38_fu_205_p3;
        else 
            ap_sig_allocacmp_idx_tmp_load_6 <= idx_tmp_fu_52;
        end if; 
    end process;

    bitcast_ln85_fu_130_p1 <= tmp_s_fu_120_p5;
    icmp_ln84_fu_99_p2 <= "1" when (idx_25_fu_48 = ap_const_lv2_3) else "0";
    icmp_ln85_10_fu_154_p2 <= "1" when (trunc_ln85_fu_144_p1 = ap_const_lv23_0) else "0";
    icmp_ln85_9_fu_148_p2 <= "0" when (tmp_58_fu_134_p4 = ap_const_lv8_FF) else "1";
    icmp_ln85_fu_108_p2 <= "1" when (ap_sig_allocacmp_idx_tmp_load_6 = ap_const_lv32_0) else "0";
    idx_36_fu_160_p3 <= 
        idx_37_fu_114_p2 when (icmp_ln85_fu_108_p2(0) = '1') else 
        idx_25_fu_48;
    idx_37_fu_114_p2 <= std_logic_vector(unsigned(idx_25_fu_48) + unsigned(ap_const_lv2_1));
    idx_38_fu_205_p3 <= 
        zext_ln81_fu_201_p1 when (icmp_ln85_reg_258(0) = '1') else 
        idx_tmp_load_6_reg_253;
    idx_fu_194_p3 <= 
        idx_37_reg_264 when (and_ln85_5_fu_189_p2(0) = '1') else 
        ap_const_lv2_0;
    ...
    or_ln85_fu_173_p2 <= (icmp_ln85_9_reg_274 or icmp_ln85_10_reg_279);
    tmp_58_fu_134_p4 <= bitcast_ln85_fu_130_p1(30 downto 23);
