...
entity ban_interface_operator_Pipeline_VITIS_LOOP_84_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ban_interface_operator_Pipeline_VITIS_LOOP_84_1 is 
...
attribute shreg_extract : string;
    ...
    signal tmp_5_fu_134_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    mux_32_32_1_1_U89 : component ban_interface_mux_32_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    and_ln85_fu_177_p2 <= (or_ln85_fu_173_p2 and grp_fu_842_p_dout0);
    ...
    grp_fu_842_p_din0 <= tmp_s_fu_120_p5;
    grp_fu_842_p_din1 <= ap_const_lv32_0;
    grp_fu_842_p_opcode <= ap_const_lv5_1;
    icmp_ln84_fu_99_p2 <= "1" when (idx_1_fu_48 = ap_const_lv2_3) else "0";
    icmp_ln85_1_fu_148_p2 <= "0" when (tmp_5_fu_134_p4 = ap_const_lv8_FF) else "1";
    ...
    tmp_5_fu_134_p4 <= bitcast_ln85_fu_130_p1(30 downto 23);
