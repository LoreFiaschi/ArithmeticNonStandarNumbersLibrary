...
entity ban_interface_operator_1_Pipeline_VITIS_LOOP_84_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ban_interface_operator_1_Pipeline_VITIS_LOOP_84_1 is 
...
attribute shreg_extract : string;
    ...
    signal idx_18_fu_114_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal idx_18_reg_264 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal idx_17_fu_160_p3 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal idx_tmp_fu_52 : STD_LOGIC_VECTOR (31 downto 0);
    signal idx_19_fu_205_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    fcmp_32ns_32ns_1_2_no_dsp_1_U416 : component ban_interface_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    mux_32_32_1_1_U417 : component ban_interface_mux_32_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    ap_sig_allocacmp_idx_tmp_load_3_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0, idx_tmp_fu_52, idx_19_fu_205_p3)
    begin
    ...
    icmp_ln85_3_fu_148_p2 <= "0" when (tmp_14_fu_134_p4 = ap_const_lv8_FF) else "1";
    icmp_ln85_4_fu_154_p2 <= "1" when (trunc_ln85_fu_144_p1 = ap_const_lv23_0) else "0";
    icmp_ln85_fu_108_p2 <= "1" when (ap_sig_allocacmp_idx_tmp_load_3 = ap_const_lv32_0) else "0";
    idx_17_fu_160_p3 <= 
        idx_18_fu_114_p2 when (icmp_ln85_fu_108_p2(0) = '1') else 
        idx_7_fu_48;
    idx_18_fu_114_p2 <= std_logic_vector(unsigned(idx_7_fu_48) + unsigned(ap_const_lv2_1));
    idx_19_fu_205_p3 <= 
        zext_ln81_fu_201_p1 when (icmp_ln85_reg_258(0) = '1') else 
        idx_tmp_load_3_reg_253;
    idx_fu_194_p3 <= 
        idx_18_reg_264 when (and_ln85_2_fu_189_p2(0) = '1') else 
        ap_const_lv2_0;
    ...
    tmp_14_fu_134_p4 <= bitcast_ln85_fu_130_p1(30 downto 23);
