...
module ban_interface_ban_interface_Pipeline_VITIS_LOOP_84_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [31:0] tmp_299;
input  [31:0] tmp_300;
output  [31:0] idx_tmp_15_out;
output   idx_tmp_15_out_ap_vld;
...
reg   [31:0] idx_tmp_15_load_1_reg_253;
wire   [0:0] icmp_ln85_fu_108_p2;
reg   [0:0] icmp_ln85_reg_258;
wire   [1:0] idx_64_fu_114_p2;
reg   [1:0] idx_64_reg_264;
...
wire   [1:0] idx_63_fu_160_p3;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [31:0] idx_tmp_15_fu_52;
wire   [31:0] idx_65_fu_205_p3;
reg   [31:0] ap_sig_allocacmp_idx_tmp_15_load_1;
wire    ap_block_pp0_stage0_01001;
wire   [31:0] bitcast_ln85_fu_130_p1;
wire   [7:0] tmp_88_fu_134_p4;
...
always @ (*) begin
    if (((icmp_ln84_fu_99_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        idx_tmp_15_out_ap_vld = 1'b1;
    end else begin
        idx_tmp_15_out_ap_vld = 1'b0;
    end
end
...
assign and_ln85_fu_177_p2 = (or_ln85_fu_173_p2 & grp_fu_7441_p_dout0);
...
assign icmp_ln84_fu_99_p2 = ((idx_43_fu_48 == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln85_3_fu_148_p2 = ((tmp_88_fu_134_p4 != 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln85_4_fu_154_p2 = ((trunc_ln85_fu_144_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln85_fu_108_p2 = ((ap_sig_allocacmp_idx_tmp_15_load_1 == 32'd0) ? 1'b1 : 1'b0);

assign idx_63_fu_160_p3 = ((icmp_ln85_fu_108_p2[0:0] == 1'b1) ? idx_64_fu_114_p2 : idx_43_fu_48);

assign idx_64_fu_114_p2 = (idx_43_fu_48 + 2'd1);

assign idx_65_fu_205_p3 = ((icmp_ln85_reg_258[0:0] == 1'b1) ? zext_ln81_fu_201_p1 : idx_tmp_15_load_1_reg_253);

assign idx_fu_194_p3 = ((and_ln85_1_fu_189_p2[0:0] == 1'b1) ? idx_64_reg_264 : 2'd0);

assign idx_tmp_15_out = idx_tmp_15_fu_52;

assign or_ln85_fu_173_p2 = (icmp_ln85_4_reg_279 | icmp_ln85_3_reg_274);

assign tmp_88_fu_134_p4 = {{bitcast_ln85_fu_130_p1[30:23]}};
...
endmodule //ban_interface_ban_interface_Pipeline_VITIS_LOOP_84_1
