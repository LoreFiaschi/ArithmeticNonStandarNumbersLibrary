set moduleName operator_Pipeline_VITIS_LOOP_215_1
set isTopModule 0
...
set C_modelName {operator/_Pipeline_VITIS_LOOP_215_1}
...
set C_modelArgList {
	...
	{ den_norm_271_out float 32 regular {pointer 1}  }
	{ den_norm_170_out float 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_read14", "interface" : "wire", "bitwidth" : 128, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "den_norm_271_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "den_norm_170_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ den_norm_1_020_out sc_out sc_lv 32 signal 2 } 
	{ den_norm_1_020_out_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ den_norm_2_019_out sc_out sc_lv 32 signal 3 } 
	{ den_norm_2_019_out_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ den_norm_271_out sc_out sc_lv 32 signal 4 } 
	{ den_norm_271_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ den_norm_170_out sc_out sc_lv 32 signal 5 } 
	{ den_norm_170_out_ap_vld sc_out sc_logic 1 outvld 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "den_norm_271_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "den_norm_271_out", "role": "default" }} , 
 	{ "name": "den_norm_271_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "den_norm_271_out", "role": "ap_vld" }} , 
 	{ "name": "den_norm_170_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "den_norm_170_out", "role": "default" }} , 
 	{ "name": "den_norm_170_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "den_norm_170_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	den_norm_271_out { ap_vld {  { den_norm_271_out out_data 1 32 }  { den_norm_271_out_ap_vld out_vld 1 1 } } }
	den_norm_170_out { ap_vld {  { den_norm_170_out out_data 1 32 }  { den_norm_170_out_ap_vld out_vld 1 1 } } }
}
