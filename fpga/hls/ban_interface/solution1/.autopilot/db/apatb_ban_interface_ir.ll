; ModuleID = '/home/lorenzo/Documents/PhD/GitHub/ArithmeticNonStandarNumbersLibrary/fpga/hls/ban_interface/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  call fastcc void @onebyonecpy_hls.p0class.Ban.122(i128* align 512 %1, %class.Ban* %0)
  call fastcc void @onebyonecpy_hls.p0class.Ban.122(i128* align 512 %3, %class.Ban* %2)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0class.Ban.122(i128* noalias align 512, %class.Ban* noalias readonly) unnamed_addr #2 {
entry:
