...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/lorenzo/Programs/Vitis_HLS/2021.2/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/lorenzo/Programs/Vitis_HLS/2021.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/lorenzo/Programs/Vitis_HLS/2021.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/lorenzo/Programs/Vitis_HLS/2021.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/usr/lib/x86_64-linux-gnu
set ::env(LD_LIBRARY_PATH) /home/lorenzo/Programs/Vitis_HLS/2021.2/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ban_interface.autotvin.dat"
	set constFileTvOut       "ban_interface.autotvout.dat"
	set constFileHdlTvIn     "ban_interface.autohdltvin.dat"
	set constFileHdlTvOut    "ban_interface.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
