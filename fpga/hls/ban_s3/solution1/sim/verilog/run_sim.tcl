...
if {[file isfile ban_interface.autotvin.dat]} {
	file delete -force ban_interface.autotvin.dat
}

if {[file isfile ban_interface.autotvout.dat]} {
	file delete -force ban_interface.autotvout.dat
}
