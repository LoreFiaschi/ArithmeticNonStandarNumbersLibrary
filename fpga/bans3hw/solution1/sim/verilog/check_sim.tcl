...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ban_interface.autotvin_b_op1.dat"
         "c.ban_interface.autotvin_b_op2.dat"
         "c.ban_interface.autotvin_f_op.dat"
         "c.ban_interface.autotvin_op.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ban_interface.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
